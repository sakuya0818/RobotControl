...
bool status_interfaces__msg__system_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // cpu_percentage
    PyObject * field = PyObject_GetAttrString(_pymsg, "cpu_percentage");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->cpu_percentage = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // memory_percentage
    PyObject * field = PyObject_GetAttrString(_pymsg, "memory_percentage");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->memory_percentage = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // memory_total
  ...
  {  // net_send
    ...
    assert(PyFloat_Check(field));
    ros_message->net_send = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // net_recv
...
PyObject * status_interfaces__msg__system_status__convert_to_py(void * raw_ros_message)
{
  ...
  {  // cpu_percentage
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->cpu_percentage);
    {
      int rc = PyObject_SetAttrString(_pymessage, "cpu_percentage", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // memory_percentage
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->memory_percentage);
    {
      int rc = PyObject_SetAttrString(_pymessage, "memory_percentage", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
