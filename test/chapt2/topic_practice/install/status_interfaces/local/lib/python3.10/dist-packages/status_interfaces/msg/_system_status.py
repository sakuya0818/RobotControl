...
class SystemStatus(metaclass=Metaclass_SystemStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.cpu_percentage = kwargs.get('cpu_percentage', float())
        self.memory_percentage = kwargs.get('memory_percentage', float())
    ...
    def __eq__(self, other):
        ...
        if self.host_name != other.host_name:
            return False
        if self.cpu_percentage != other.cpu_percentage:
            return False
        if self.memory_percentage != other.memory_percentage:
            return False
    ...
    def cpu_percentage(self):
        """Message field 'cpu_percentage'."""
        return self._cpu_percentage

    @cpu_percentage.setter
    def cpu_percentage(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'cpu_percentage' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'cpu_percentage' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._cpu_percentage = value

    @builtins.property
    def memory_percentage(self):
        """Message field 'memory_percentage'."""
        return self._memory_percentage

    @memory_percentage.setter
    def memory_percentage(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'memory_percentage' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'memory_percentage' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._memory_percentage = value
    ...
    def net_send(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'net_send' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
