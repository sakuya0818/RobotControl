...
struct SystemStatus_
{
  ...
  using _cpu_percentage_type =
    float;
  _cpu_percentage_type cpu_percentage;
  using _memory_percentage_type =
    float;
  _memory_percentage_type memory_percentage;
  ...
  Type & set__cpu_percentage(
    const float & _arg)
  {
    this->cpu_percentage = _arg;
    return *this;
  }
  Type & set__memory_percentage(
    const float & _arg)
  {
    this->memory_percentage = _arg;
    return *this;
  }
  ...
  bool operator==(const SystemStatus_ & other) const
  {
    ...
    if (this->cpu_percentage != other.cpu_percentage) {
      return false;
    }
    if (this->memory_percentage != other.memory_percentage) {
      return false;
    }
