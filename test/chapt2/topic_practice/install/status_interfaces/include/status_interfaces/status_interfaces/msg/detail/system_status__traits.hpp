  ...
  std::ostream & out)
{
  ...
  // member: cpu_percentage
  {
    out << "cpu_percentage: ";
    rosidl_generator_traits::value_to_yaml(msg.cpu_percentage, out);
    out << ", ";
  }

  // member: memory_percentage
  {
    out << "memory_percentage: ";
    rosidl_generator_traits::value_to_yaml(msg.memory_percentage, out);
    out << ", ";
  }
