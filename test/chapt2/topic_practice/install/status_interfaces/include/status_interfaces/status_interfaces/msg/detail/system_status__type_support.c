...
static rosidl_typesupport_introspection_c__MessageMember status_interfaces__msg__SystemStatus__rosidl_typesupport_introspection_c__SystemStatus_message_member_array[8] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(status_interfaces__msg__SystemStatus, cpu_percentage),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(status_interfaces__msg__SystemStatus, memory_percentage),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
