...
status_interfaces__msg__SystemStatus__are_equal(const status_interfaces__msg__SystemStatus * lhs, const status_interfaces__msg__SystemStatus * rhs)
{
  ...
  // cpu_percentage
  if (lhs->cpu_percentage != rhs->cpu_percentage) {
    return false;
  }
  // memory_percentage
  if (lhs->memory_percentage != rhs->memory_percentage) {
    return false;
  }
  // memory_total
  ...
  status_interfaces__msg__SystemStatus * output)
{
  ...
  // cpu_percentage
  output->cpu_percentage = input->cpu_percentage;
  // memory_percentage
  output->memory_percentage = input->memory_percentage;
  // memory_total
