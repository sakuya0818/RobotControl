...
class Init_SystemStatus_memory_percentage
{
public:
  explicit Init_SystemStatus_memory_percentage(::status_interfaces::msg::SystemStatus & msg)
  : msg_(msg)
  {}
  Init_SystemStatus_memory_total memory_percentage(::status_interfaces::msg::SystemStatus::_memory_percentage_type arg)
  {
    msg_.memory_percentage = std::move(arg);
...
class Init_SystemStatus_cpu_percentage
{
public:
  explicit Init_SystemStatus_cpu_percentage(::status_interfaces::msg::SystemStatus & msg)
  : msg_(msg)
  {}
  Init_SystemStatus_memory_percentage cpu_percentage(::status_interfaces::msg::SystemStatus::_cpu_percentage_type arg)
  {
    msg_.cpu_percentage = std::move(arg);
    return Init_SystemStatus_memory_percentage(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_SystemStatus_cpu_percentage host_name(::status_interfaces::msg::SystemStatus::_host_name_type arg)
  {
    msg_.host_name = std::move(arg);
    return Init_SystemStatus_cpu_percentage(msg_);
  }
